...
exports.trackMetaFromJSON = function (str) {
    return exports.trackObjToFriendly(JSON.parse(str).track);
}

// Parses a JSON search results string into an array of track object...
exports.searchResultsFromJSON = function (str) {
    return exports.trackObjToFriendly(JSON.parse(str).tracks);
}
